      ...
      <el-row type="flex" class="row-bg" justify="start">
        <el-col class="header-logo-selector" :span="24">
          ...
          <el-dropdown class="page-selector" @command="menuChanged">
            <div class="area-name">
              Overview<i class="el-icon-arrow-down el-icon--right"></i>
            </div>
                  ...
                  <el-popover
                    ...
                    <el-container >
                      <el-main v-popover="project.name + 'popover'" class="epic-container-column__project__internal">
                        <el-row>
                          <div>
                            <div class="epic-container-column__project__area">{{ project.area }}</div>
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      try {
        this.areaData = (await AreaData.createOverview()).sortedByObjectiveLength();
